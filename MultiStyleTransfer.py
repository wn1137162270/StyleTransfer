...
def evaluate(input_image, content_size, style_image, output_image, model="models/21styles.model", style_size=512, ngf = 128, cuda = 0):
    content_image = utils.tensor_load_rgbimage(input_image, size=content_size, keep_asp=True)
    content_image = content_image.unsqueeze(0)
    style = utils.tensor_load_rgbimage(style_image, style_size)
